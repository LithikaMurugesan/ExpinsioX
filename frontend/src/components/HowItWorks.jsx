...
// const HowItWorks = () => {
//   return (
//     <section id="HowItWorks" className="bg-[#020617] py-28 m-0.5 rounded-2xl">
...
//           >
//             <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 w-full md:w-[70%] flex gap-6 items-center">
//               <div
